...
public class SearchHistoryController : ControllerBase
{
        ...
        [FromBody] SearchHistoryRequestDto dto, CancellationToken ct)
    {
        ...
        await _service.SaveAsync(TEST_USER_ID, dto, ct);
    ...
    {
        var result = await _service.GetHistoryAsync(TEST_USER_ID, limit, ct);
    ...
    {
        var ok = await _service.DeleteOneAsync(TEST_USER_ID, id, ct);
        return ok
    ...
    {
        await _service.DeleteAllAsync(TEST_USER_ID, ct);
    ...
    {
        var result = await _service.GetSuggestionsAsync(TEST_USER_ID, q, ct);
        return Ok(ApiResponse<object>.Ok(result,
