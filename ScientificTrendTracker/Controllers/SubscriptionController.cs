...
public class SubscriptionController : ControllerBase
{
    ...
    // Tạm thời hardcode userId = 1 để kiểm thử
    ...
    {
        var result = await _subscriptionService.GetSubscriptionStatusAsync(TEST_USER_ID, ct);
    ...
    {
        var success = await _subscriptionService.SubscribePlanAsync(TEST_USER_ID, dto, ct);
