...
const AdminToast = ({ message, onClose }: AdminToastProps) => {
  ...
  return (
    <div className="fixed right-6 top-20 z-50 max-w-sm rounded-lg border border-emerald-200 bg-white px-4 py-3 text-sm font-semibold text-slate-800 shadow-xl">
