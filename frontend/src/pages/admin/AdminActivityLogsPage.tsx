  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-xs text-slate-500">Audit trail of administrative actions.</p>
      </div>
      ...
      >
        <div className="space-y-3 p-4">
          {logs.length === 0 && <p className="text-sm text-slate-400">No activity recorded yet.</p>}
          {logs.map((log, index) => (
