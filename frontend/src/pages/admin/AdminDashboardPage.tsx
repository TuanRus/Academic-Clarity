...
const growthTextClass = (growth: string) => {
...
const growthTooltipClass = (growth: string) => {
  const value = parseInt(growth, 10);
...
const AdminDashboardPage = () => {
  ...
  const collapseClass = (
    ...
    `overflow-hidden transition-all duration-300 ease-in-out ${collapsedSections[section] ? 'max-h-0 opacity-0' : `${openHeight} opacity-100`
    }`;
    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-5 lg:grid-cols-2 xl:grid-cols-4">
        <AdminMetricCard
          ...
          helper="Articles stored in the system"
          icon="▤"
          accent="blue"
        />
        ...
        <AdminMetricCard
          ...
          helper="Distinct authors in the research corpus"
          icon="◉"
          accent="slate"
        />
        ...
        <AdminMetricCard
          ...
          helper="Revenue collected from subscriptions"
          icon="₫"
          accent="green"
        />
                ...
                {revenueTrend.map((item) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        height: `${revenueBarHeight(item.value)}px`,
                      }}
                    />
                    ...
                    <div className="pointer-events-none absolute bottom-16 z-10 hidden rounded-lg bg-slate-950 px-3 py-2 text-xs text-white shadow-lg group-hover:block">
                      ...
                      <p className={growthTextClass(item.growth)}>
                        {item.growth} vs previous month
                      </p>
                    </div>
                ...
                <div key={item.month}>
                  <div className="mb-1 flex justify-between text-xs font-semibold text-slate-600">
                    ...
                    <span>
                      ...
                      <span className={growthTextClass(item.growth)}>
                        {item.growth}
                      </span>
                    </span>
                  </div>
