...
public interface ISubscriptionService
{
    ...
    /// <summary>
    /// Admin xoá cứng một gói cước. Chỉ xoá được khi chưa có người dùng nào đăng ký gói này.
    /// </summary>
    /// <param name="planId">Số nguyên Int - NGUỒN: Route Parameter - ID gói cước.</param>
    /// <param name="ct">CancellationToken - NGUỒN: ASP.NET Core runtime.</param>
    /// <returns>"OK" nếu xoá thành công; "NOT_FOUND" nếu không tồn tại; "IN_USE" nếu đã có người đăng ký.</returns>
    Task<string> DeletePlanAsync(int planId, CancellationToken ct);
}
