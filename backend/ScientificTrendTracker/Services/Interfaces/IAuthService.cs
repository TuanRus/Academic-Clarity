...
namespace ScientificTrendTracker.Services.Interfaces
{
    ...
    public interface IAuthService
    {
        ...
        /// <summary>
        /// Lấy hồ sơ user hiện tại đọc thẳng từ DB theo UserId (giải mã từ token).
        /// </summary>
        /// <param name="userId">int - Mã định danh user lấy từ claim NameIdentifier.</param>
        /// <returns>UserProfileDto nếu tồn tại, ngược lại null.</returns>
        Task<UserProfileDto?> GetProfileAsync(int userId);

        /// <summary>Cập nhật Full Name + Institution cho user đang đăng nhập. Trả hồ sơ mới hoặc null nếu không tìm thấy.</summary>
        Task<UserProfileDto?> UpdateProfileAsync(int userId, UpdateProfileDto dto);

        /// <summary>Đổi mật khẩu khi đã đăng nhập. Trả null nếu thành công, ngược lại trả thông báo lỗi (sai mật khẩu cũ / trùng mật khẩu cũ / không tìm thấy).</summary>
