...
namespace ScientificTrendTracker.Models.DTOs
{
    ...
    /// <summary>DTO đổi vai trò (RoleId) của một user từ trang quản trị.</summary>
    public record UpdateUserRoleDto
    {
        /// <summary>Mã vai trò mới (1-admin, 2-researcher, 3-edu/student, 4-regular).</summary>
        public int RoleId { get; init; }
    }

    /// <summary>DTO trả về thông tin hồ sơ user hiện tại (đọc thẳng từ DB theo token).</summary>
    ...
    /// <summary>DTO đổi mật khẩu khi đã đăng nhập (cần mật khẩu cũ để xác thực).</summary>
    ...
    /// <summary>DTO cập nhật hồ sơ cá nhân (Full Name + Institution). Email/Role không cho đổi ở đây.</summary>
    public record UpdateProfileDto
    {
        [Required(ErrorMessage = "Full name is required.")]
        [StringLength(150, MinimumLength = 1, ErrorMessage = "Full name must be 1–150 characters.")]
        public string Fullname { get; init; } = null!;

        [StringLength(255, ErrorMessage = "Institution must be at most 255 characters.")]
        public string? Institution { get; init; }
    }
